...
// 			// 子供の名前が"_end"で終わる場合にuseGravityをtrueに設定
// 			if (child != null && child.name.EndsWith("_end"))
// 			{
// 				useGravity = true;
// 			}
// 		}
...
// 			if (useGravity)
// 			{
// 				force += gravity * Time.deltaTime / sqrDt;
// 			}
...
namespace UnityChan
{
	public class SpringBone : MonoBehaviour
	{
		...
		// 重力の大きさ
		public float gravityNum = 0.001f; // *-1
		...
		public void UpdateSpring()
		{
			...
			if (useGravity)
			{
				gravity = new Vector3(0.0f, -gravityNum, 0.0f);
				force += gravity / sqrDt;
			}
